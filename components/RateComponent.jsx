    ...
    <section className="flex flex-col lg:flex-row items-start gap-8 px-8 py-12 md:px-16 lg:px-24 bg-gray-50">
      ...
      <div className="w-full lg:w-1/2 space-y-6">
        ...
        <p className="text-gray-600 leading-relaxed">
          ...
          we prioritize affordability and transparency in our debt recovery services. Our rates are competitive, 
          ensuring you receive exceptional value without hidden costs or unexpected fees.
        </p>
        <p className="text-gray-600 leading-relaxed">
          We work to provide a cost-effective solution tailored to your financial needs, 
          helping you regain stability with rates that align with industry standards.
        </p>
        <div className="mt-5">
      ...
      {/* Right Section with Image and Feature Cards */}
      <div className="w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <h3 className="text-lg font-semibold">Clear and Transparent Documentation</h3>
          <p className="text-sm mt-1">
            Our terms are straightforward, with no hidden fees or unclear language. Know exactly what you’re paying for.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm mt-1">
            Our rates are designed to offer industry-leading value without sacrificing quality of service.
          </p>
        </motion.div>

        {/* Image 2 */}
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <img src={atm} alt="Accessible Payment Options" className="w-full h-full object-cover" />
        </div>
      </div>
    </section>
  );
